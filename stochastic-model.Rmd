  ...
  with(                                #use with to simplify code
       as.list(params), 
       {
        ...
        # betat <- beta(beta0, t)
         ...
         rates <- as.numeric(c(beta0*(I)/N,                           # movements out of S
...
```{r evaluate}
evaluate.model <- function(params=list(beta0=0.657, sigma=1/6.4, z=45, b=0.143, a0=0.0446, w=40, dt=0.05),
...
* Add calculations about unobserved cases
* Add references
