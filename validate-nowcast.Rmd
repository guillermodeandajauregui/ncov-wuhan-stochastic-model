...
out <- evaluate.model(params=list(beta0=0.6584, sigma=1/6.4, z=28, b=0.143, a0=1/1.5, w=42, presymptomatic=1, c=1, dt=0.05),
                                       init = list(S=10600000, E1=0, E2=0, E3=0, E4=0, E5=0, E6=0,
                                                   I1 = 1, I2= 0, I3=0, I4=0, Iu1=0, Iu2=0, Iu3=0, Iu4=0,
                                                   H=0, Ru=0, C=0),
                                nstep = (as.numeric(today-start)+1+84)/params$dt,   # solve for 12 weeks from current time
                                nsims=1, start=as.Date("2020-03-01"))
plot.model(out, log='', title='Nowcast validation: Scenario 1')
...
nowcast.validation.1 <- data.frame(case.notifications, new.infections, unobserved)
plot(nowcast.validation.1)
write.csv(nowcast.validation.1, file='nowcast-validation-1.csv')
```
